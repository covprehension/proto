...
to move-citizens
  ask citizens[
    if confinement?
    [
      if ticks >= Confinement-tick AND  ticks <= (Confinement-tick + Confinement-duree)  [
        move-to my-house
      ]
    ]
...
<experiments>
  <experiment name="experiment" repetitions="40" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="Confinement-tick" first="10" step="5" last="50"/>
    <steppedValueSet variable="Confinement-duree" first="10" step="5" last="60"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
