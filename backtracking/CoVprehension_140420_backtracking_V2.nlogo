...
to-report %locked
  report count citizens with [lockdown = 1] / population-size
end

to-report nb-tests
  report sum  [get-tested?] of citizens / population-size
end

to-report %tested
  report count citizens with  [get-tested? > 0] / population-size
end
