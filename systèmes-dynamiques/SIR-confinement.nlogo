...
to setup
  ...
  set taux-contact-horsconfinement taux_de_contact
  set taux-contact-confinement taux_de_contact / 10
  set time-start-confinement 200 * dt ;;dt pour le ramener à des ticks
  set time-end-confinement 1000 * dt ;; dt pour ramener à des ticks
...
;;entree confinement
  if ( ticks > time-start-confinement) [set taux_de_contact taux-contact-confinement]
;;sortie confinement
  if (ticks > time-end-confinement) [set taux_de_contact taux-contact-horsconfinement]
end
...
0.01
    org.nlogo.sdm.gui.AggregateDrawing 11
        ...
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 130 188 183 458 69 50 50
            org.nlogo.sdm.gui.WrappedConverter "taux_de_guérison" "taux_guérison"
        org.nlogo.sdm.gui.BindingConnection 2 469 105 385 177 NULL NULL 0 0 0
