...
to set_scenario_Confinement
  set taux-contact 0.001
  set taux-contact-confinement (taux-contact / 10)
  set taux-contact-hors-confinement taux-contact
  set taux-contagion 0.1
  set taux-guerison 0.1
  set time-start-confinement (100 * dt)
  set time-end-confinement (500 * dt)
  set explication "Situation de référence en l'absence de réaction de la société à l'épidémie en cours. On observe que...(à compléter)."
end
...
;  set nouveaux-infectés taux-contact * taux-contagion * sains * infectés ;;modif taux_contagion en taux_de_contagion
  ...
  update-indicators ;; pour faire evoluer les indicateurs
   update-max-Ir
  if Scenarios = "Confinement" [wait 0.1]
  end



to active-confinement
  set time-activation-confinement (lockdown-date / dt)
...
SCENARIOS
SCENARIOS
"Laisser-faire" "Confinement" "Traitement"
1
...
"" ""
PENS
"infectés        " 1.0 1 -2674135 true "" "plot nouveaux-infectés"
...
0.01
    org.nlogo.sdm.gui.AggregateDrawing 11
        ...
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 130 188 183 239 51 50 50
            org.nlogo.sdm.gui.WrappedConverter "taux-contagion" "taux_contagion"
        ...
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 130 188 183 458 69 50 50
            org.nlogo.sdm.gui.WrappedConverter "taux-guerison" "taux_guérison"
        ...
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 130 188 183 116 71 50 50
            org.nlogo.sdm.gui.WrappedConverter "taux-contact" "taux_contact"
