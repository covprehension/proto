...
to setup-globals
  ...
  niveau-difficulté = "Intermédiaire" [0.02 * population-size]
...
(population-size - nb-I-Total) / population-size * 100
1
1
11
...
"" ""
PENS
"Objectif" 1.0 0 -13840069 true "" "if ticks > 0 [plotxy nb-day-confinement ((population-size - nb-I-Total) / population-size * 100)]"
