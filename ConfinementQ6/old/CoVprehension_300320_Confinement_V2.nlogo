...
"" ""
PENS
"S" 1.0 0 -13840069 true "" "if nb-S > 0 [plot nb-S / population-size * 100]"
"I" 1.0 0 -2674135 true "" "if nb-Ir > 0 [plot (nb-Ir  / population-size * 100)]"
"R" 1.0 0 -7500403 true "" "if nb-R > 0 [plot (nb-R / population-size  * 100)]"
...
"" ""
PENS
"Objectif" 1.0 0 -13791810 true "" "if ticks > 0 [plotxy nb-day-confinement nb-I-Total]"
...
Developped by Frédéric Amblard for https://covprehension.org/
@#$#@#$#@
default
true
0
